...
(function($) {
    ...
    var ssPrettyPrint = function() {
        ...
        function logoWhite(){
                document.getElementById("logo").src = "images/NEWRHIJSwhite.png";
            }
        function logoBlack(){
                document.getElementById("logo").src = "images/NEWRHIJSblack.png";
            }
    ...
    var ssMoveHeader = function () {
        ...
        var hero = $('.page-hero'),
            hdr = $('header'),
            triggerHeight = hero.outerHeight() * 0.2;
    ...
    var ssMobileMenu = function() {
        ...
        toggleButton.on('click', function(event){
            ...
            clicked=true;
                ...
                setTimeout(function(){logoBlack()}, 300);
            clicked=false;
            }
